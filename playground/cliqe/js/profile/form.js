...
fetch(profile, options)
  ...
  .then((result) => {
    ...
    document.getElementById("location").innerHTML = regionNames.of(
      result.location
    );
    document.getElementById("job_title").innerHTML =
      result.job_title != null ? result.job_title : "-";
    document.getElementById("personal_bio").innerHTML =
      result.personal_bio != null ? result.personal_bio : "-";
...
document
  ...
  .addEventListener("change", handle, false);
